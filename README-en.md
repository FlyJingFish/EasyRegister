...
- New version
  ...
  plugins {
    ...
    id "io.github.FlyJingFish.EasyRegister" version "1.0.4" apply false
  }
  ```
...
- Or old version
  ...
  buildscript {
    dependencies {
      //Required item 👇
      classpath 'io.github.FlyJingFish.EasyRegister:plugin:1.0.4'
    }
  }
  ```
...
dependencies {
  implementation 'io.github.FlyJingFish.EasyRegister:plugin:1.0.4'
}
```

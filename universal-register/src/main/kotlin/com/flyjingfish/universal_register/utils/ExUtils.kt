...
fun registerCompileTempWovenJson(project:Project, variantName:String):String{
    return project.buildDir.absolutePath + "/tmp/universal-register/${variantName}/tempCompileClassJson/needDelWovenClassInfo.json".adapterOSPath()
}
fun registerCompileTempDir(project: Project, variantName:String):String{
    return project.buildDir.absolutePath + "/tmp/universal-register/${variantName}/tempCompileClass/".adapterOSPath()
}

fun hintCleanFile(project: Project):String{
    return project.buildDir.absolutePath + "/tmp/universal-register/hintClean.json".adapterOSPath()
}
